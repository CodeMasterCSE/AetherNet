...
class _DiscoveryScreenState extends ConsumerState<DiscoveryScreen> {
    ...
    await nearbyService.requestConnection(
      ...
      (id, Status status) {
        ...
        if (status == Status.CONNECTED) {
          ...
          // questions before we navigate to ExamTakingScreen
          ref.read(syncProvider);
          Nearby().stopDiscovery(); // Only stop discovery, don't disconnect!
          Navigator.pushReplacement(
            context,
            PageRouteBuilder(
              pageBuilder: (_, __, ___) => const ExamTakingScreen(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Find Exam Sessions',
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Text(
          isScanning ? 'Scanning for sessions...' : 'Sessions found nearby!',
          style: TextStyle(
            fontSize: 18,
    ...
    return const Column(
      ...
      children: [
        Text('No sessions found yet.',
          ...
          SizedBox(height: 8),
          Text(
            'Ask your teacher to start an exam session.',
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    parts.length > 1 ? parts[1] : endpointName, // Paper Name
                  ...
                  const SizedBox(height: 4),
                  Text(
                    parts.isNotEmpty ? 'Teacher: ${parts[0]}' : 'Tap to join this session',
